...
public class InvoiceItemServiceImpl implements InvoiceItemService {
    ...
    public InvoiceItemServiceImpl(InvoiceItemRepository itemRepository, InvoiceRepository invoiceRepository,
                                  ProductRepository productRepository, InvoiceItemMapper mapper,
    ...
    public InvoiceItemResponse addItemToInvoice(Long organizationId, Long invoiceId, CreateInvoiceItemRequest request) {
        ...
        if (request.productId() != null) item.setProduct(findProduct(organizationId, request.productId()));
